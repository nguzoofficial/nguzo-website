...
<section class="section section-hiw" id="how-it-works" aria-labelledby="hiw-title">
  <div class="container">
    <div class="section-header reveal">
      <p class="label" data-en="How it works" data-fr="Comment ça marche">How it works</p>
      <h2 id="hiw-title" data-en="Three steps. That's it." data-fr="Trois étapes. C'est tout.">Three steps. That's it.
      </h2>
      <p class="section-sub"
        ...
        The only action on any listing is "Message the seller" — no payment buttons, no cart, no checkout. That's
        intentional.
      </p>
    </div>
    ...
    <ol class="steps" role="list">
      <li class="step reveal">
        ...
        <div class="step__body">
          ...
          <h3 data-en="Browse or list nearby" data-fr="Parcourir ou publier à proximité">Browse or list nearby</h3>
          <p data-en="Items are sorted by distance from you, not by who paid to be first. Post what you're selling in under a minute."
            ...
            Items are sorted by distance from you, not by who paid to be first. Post what you're selling in under a
            minute.
          </p>
        </div>
      </li>
      <li class="step reveal reveal-d1">
        ...
        <div class="step__body">
          ...
          <h3 data-en="Message the seller directly" data-fr="Contacter le vendeur directement">Message the seller
            directly</h3>
          <p data-en="Ask questions, agree on a price, choose a meeting spot. No phone numbers needed, no third party reads your conversation."
            ...
            Ask questions, agree on a price, choose a meeting spot. No phone numbers needed, no third party reads your
            conversation.
          </p>
        </div>
      </li>
      <li class="step reveal reveal-d2">
        ...
        <div class="step__body">
          ...
          <h3 data-en="Meet safely, exchange in person" data-fr="Rencontrez-vous en sécurité, échangez en personne">Meet
            safely, exchange in person</h3>
...
<section class="section section-dark section-app" id="the-app" aria-labelledby="app-title">
  <div class="container">
    <div class="section-header section-header--light reveal">
      <p class="label" data-en="The App" data-fr="L'Application">The App</p>
      <h2 id="app-title" data-en="Everything you need, nothing you don't."
    ...
    <div class="app-screens">
      <figure class="app-screen reveal">
        <div class="app-screen__frame">
          <img src="images/app-feed.png" alt="Nguzo feed screen: list of nearby listings in Buyenzi with prices in BIF"
      ...
      <figure class="app-screen app-screen--featured reveal reveal-d1">
        <div class="app-screen__frame">
          <img src="images/app-listing.png"
            alt="Listing detail: iron for 80,000 BIF in Buyenzi Kanzigiri, with chat button" width="280" height="560"
            loading="lazy" decoding="async" />
        </div>
        <figcaption data-en="Listing detail — the only action is to message"
          data-fr="Détail d'annonce — la seule action est de discuter">Listing detail — the only action is to message
        </figcaption>
      </figure>

      <figure class="app-screen reveal reveal-d2">
        <div class="app-screen__frame">
          <img src="images/app-profile.png" alt="User profile showing active listings and create listing button"
            width="280" height="560" loading="lazy" decoding="async" />
        </div>
