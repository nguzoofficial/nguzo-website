    ...
    <div class="container">
        <div class="contact-inner">
            ...
            <div class="contact-left reveal">
                ...
                <h2 id="contact-title" data-en="Ready to find something nearby?"
                ...
                <a href="https://play.google.com/store/apps/details?id=co.nguzo.app" target="_blank"
                    rel="noopener noreferrer" class="btn btn-primary btn-lg" aria-label="Download Nguzo on Google Play">
                    <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <path
                            d="M2.1 23.68c.33.18.72.21 1.08.08L13.94 12 2.1.32C1.44.68 1 1.37 1 2.16v19.68c0 .79.44 1.48 1.1 1.84z" />
                        <path d="M16.75 16.64l2.81 2.82 1.65-.95c.6-.35.96-.98.96-1.68v-1.53l-5.42 1.34z" /></svg>
                    <span data-en="Download on Google Play" data-fr="Télécharger sur Google Play">Download on Google
                        Play</span>
                </a>
            ...
            <div class="contact-right reveal reveal-d1">
                <form id="contact-form" class="contact-form" action="https://api.web3form.com/submit" method="POST"
                    novalidate>
                    ...
                    <div class="field-row">
                        <div class="field">
                            ...
                            <input type="text" id="f-name" name="name" required aria-required="true"
                                data-ph-en="Your full name" data-ph-fr="Votre nom complet"
                        ...
                        <div class="field">
                            ...
                            <input type="email" id="f-email" name="email" required aria-required="true"
                                autocomplete="email" data-ph-en="you@example.com" data-ph-fr="vous@exemple.com"
                    ...
                    <div class="field">
                        ...
                        <textarea id="f-message" name="message" required aria-required="true" rows="5"
                            data-ph-en="Tell us what you need..." data-ph-fr="Dites-nous ce dont vous avez besoin..."
                    ...
                    <div class="form-ok" id="form-ok" hidden role="status" aria-live="polite">
                        ...
                        <span data-en="Thank you — we received your message."
                            data-fr="Merci — nous avons reçu votre message.">Thank you — we received your
                            message.</span>
                    </div>
                    <div class="form-error" id="form-error" hidden role="status" aria-live="assertive">
                        ...
                        <span data-en="Something went wrong. Please try again."
                            data-fr="Une erreur est survenue. Veuillez réessayer.">Something went wrong. Please try
                            again.</span>
                    </div>
                </form>
            </div>
